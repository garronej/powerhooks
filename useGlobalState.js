...
var getPersistentStorage = (function () {
    ...
    function getPersistentStorage(params) {
        ...
        switch (mechanism) {
            ...
            case "cookies": return getCookieImplementationOfPersistantStorage({ key: key });
        }
    }
...
initialState, params) {
    var _a;
    var _b = (params !== null && params !== void 0 ? params : {}).persistance, persistance = _b === void 0 ? "cookies" : _b;
