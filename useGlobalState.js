...
initialState, params) {
    var _a;
    var _b = (params !== null && params !== void 0 ? params : {}).persistance, persistance = _b === void 0 ? "localStorage" : _b;
    ...
    function useXyz() {
        ...
        return _a = {},
            ...
            _a["set" + capitalize_1.capitalize(name)] = useConstCallback_1.useConstCallback(function (setStateAction) {
                return evtXyz.state =
                    typeGuard_1.typeGuard(setStateAction, typeof setStateAction === "function") ?
                        setStateAction(xyz) :
                        setStateAction;
            }),
            _a;
