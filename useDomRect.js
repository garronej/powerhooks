...
function useDomRect() {
    ...
    hooks_1.useEvt(function (ctx) {
        ...
        evt_1.Evt.from(ctx, resize_observer_polyfill_1.default, htmlElement)
            .toStateful()
            .attach(function () {
            /*
...
function ZoomProvider(props) {
    ...
    return react_1.createElement(zoomContext.Provider, { "value": { referenceWidth: referenceWidth } }, jsx_runtime_1.jsx("div", __assign({ style: {
            "height": "100vh",
            "overflow": "hidden"
