...
export function withDarkMode(App: NextComponentType | any, config?: Partial<Config>) {
  ...
  function DarkMode({ autoMode, darkMode, initialProps, ...props }: AppProps) {
    ...
    return <DarkModeContext.Provider value={state}><App {...props} {...initialProps} /></DarkModeContext.Provider>
  }
