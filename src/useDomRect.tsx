...
export function useDomRect<T extends HTMLElement = any>(params: {
    ref: React.RefObject<T>;
}): { domRect: PartialDomRect };
export function useDomRect<T extends HTMLElement = any>(params?: {
    ref: React.RefObject<T>;
}): { ref: React.RefObject<T>; domRect: PartialDomRect } {
            ...
            Evt.from(ctx, ResizeObserver, element)
                ...
                .attach(domRect =>
                    setDomRect(currentDomRect =>
                        same(currentDomRect, domRect) ? currentDomRect : domRect
                    )
                );
        },
        [ref.current]
