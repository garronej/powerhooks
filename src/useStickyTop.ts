...
export function useStickyTop<T extends HTMLElement = any>(): {
    ref: React.RefObject<T>;
    top: number | undefined;
};
export function useStickyTop<T extends HTMLElement = any>(params: {
    ref: React.RefObject<T>;
}): { top: number | undefined };
export function useStickyTop<T extends HTMLElement = any>(params?: {
    ref: React.RefObject<T>;
}): { ref: React.RefObject<T>; top: number | undefined } {
